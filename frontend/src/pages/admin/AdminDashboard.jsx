...
const AdminDashboard = () => {
  ...
  const advancedFields = {
    ...
    exams: [
      ...
      },
      {
        ...
        label: 'Exam Type',
        type: 'select',
        options: ['INTERNAL', 'MIDTERM', 'PRACTICAL', 'FINAL'].map(
          (value) => ({
            value,
            label: value
          })
    ...
    timetable: [
      ...
      },
      {
        ...
        options: faculty.map((member) => ({
          value: member.id,
          label: `${member.name} (${member.faculty_id})`
        }))
      },
      {
        name: 'roomId',
        ...
        options: rooms.map((room) => ({
          value: room.id,
          label: `${room.room_number} — ${room.building}`
        }))
      },
      {
        name: 'dayOfWeek',
  ...
  const handleSubmitForm = async (e) => {
    ...
    if (!e.currentTarget.checkValidity()) {
      setFormError(
        'Please complete every required field before creating this record.'
      );
    ...
    try {
      ...
      else if (activeTab === 'courses') endpoint = '/courses';
      else if (activeTab === 'subjects') endpoint = '/subjects';
      else if (activeTab === 'rooms') endpoint = '/rooms';
      else if (activeTab === 'students') endpoint = '/students';
      else if (activeTab === 'faculty') endpoint = '/faculty';
      else if (activeTab === 'enrollments') endpoint = '/enrollments';
      else if (activeTab === 'exams') endpoint = '/exams';
      else if (activeTab === 'timetable') endpoint = '/timetable';
      else if (activeTab === 'fees') endpoint = '/fees';
      else if (activeTab === 'notices') endpoint = '/notices';
      ...
      const message =
        ...
        err.message ||
        'Operation failed. Please check the information and try again.';
    ...
    >
      ...
      >
        <div>
          ...
          >
            Full operational university control, CRUD
                ...
                >
                  ...
                  <tbody>
                    {enrollments
                      .filter(
                        (enrollment) =>
                          `${enrollment.student_name} ${enrollment.roll_number} ${enrollment.subject_name}`
                            .toLowerCase()
                            .includes(
                              search.toLowerCase()
                            )
                ...
                >
                  ...
                  <tbody>
                    {timetables
                      .filter(
                        (slot) =>
                          `${slot.subject_name} ${slot.course_name} ${slot.faculty_name}`
                            .toLowerCase()
                            .includes(
                              search.toLowerCase()
                            )
